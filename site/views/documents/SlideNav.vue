<template>
  <div class="ha-doc-nav">
    <div class="ha-doc-nav__group">
      <div
        :class="['ha-doc-nav__title', this.activeName == Format.camel2Dash(doc.name) ? 'active' : '']"
        :index="Format.camel2Dash(doc.name)"
      ...
      <div class="ha-doc-nav__group">
        ...
        <div
          :class="['ha-doc-nav__item', this.activeName == Format.camel2Dash(component.name) ? 'active' : '']"
          :index="Format.camel2Dash(component.name)"
          v-for="(component, index) in componentNav.form"
          :key="index"
          @click="handleOpen(component)"
        >
          <a :href="getLinkPath(component)"
            >{{ component.name }}<span class="chinese">{{ component.description }}</span></a
          >
        </div>
      </div>
      <div class="ha-doc-nav__group">
